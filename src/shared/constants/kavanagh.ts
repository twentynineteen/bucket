 ...
 * render (mark present on every one of 256 coarse samples over heavily textured
 * footage) measured presence 0.9333 to 0.9996, so the documented floor follows the
 * weakest honest measurement.
 */
