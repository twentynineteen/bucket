...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    /**
     * Omits the corner close button. For dialogs that refuse to close while
     * work is in flight, so the button is not shown looking clickable while
     * the guard ignores it (#282).
     */
    hideClose?: boolean
  }
